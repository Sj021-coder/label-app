...
// Relative, not "@/..." — this file needs to be importable from
// netlify/functions/daily-sync-worker.mjs too (the weekly-window
// notification trigger), which is bundled separately from the Next.js app
// and doesn't understand that alias.
