...
// --- Shared calendar week (for duels + team recap) ---
// Unlike the personal Bilan clock, duels and team recaps are SHARED — two
// teams/players duel on the same week, together. Anchored to the same
// Monday 08:00 UTC used everywhere else in the weekly programme.
export function getSharedWeek(now = new Date()) {
  const start = mondayAt8UTC(now);
